  ...
  const processResults = async () => {
    try {
      ...
      if (userId) {
        ...
        else if (cepsScores.totalScore >= 200)
          ...
          <Card className="p-8 text-center bg-gradient-to-r from-blue-500 to-purple-600 text-white">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <div className="text-blue-100">Puntuación Total / 250</div>
              </div>
              ...
              <div>
                ...
                <div className="text-blue-100">Nivel General</div>
              </div>
              ...
              <div>
                ...
                <div className="text-blue-100">Tiempo Empleado</div>
              </div>
            </div>
          </Card>
        </motion.div>
          ...
          <Card className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {meta.competencies.map((comp: any, index: number) => {
                ...
                const recommendation = getCompetencyRecommendation(
                  comp.key,
                  level,
                );
