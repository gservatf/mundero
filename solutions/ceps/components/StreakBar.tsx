        ...
        <div className={`${className}`}>
            <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                    <motion.div
                        animate={showAnimation && streak > 0 ? {
                            rotate: [0, 10, -10, 0],
                            scale: [1, 1.1, 1]
                        } : {}}
                ...
                <div className="flex items-center gap-1">
                    <motion.span
                        className={`text-lg font-bold ${isMaxStreak ? 'text-yellow-600' : 'text-blue-600'
                            }`}
            ...
            >
                <span className={`text-sm font-medium ${isMaxStreak ? 'text-yellow-600' : 'text-blue-600'
                    }`}>
                    {getStreakMessage()}
                </span>
