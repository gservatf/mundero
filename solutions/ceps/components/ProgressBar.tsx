  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <div className="flex justify-between mt-2 text-xs text-gray-500">
        <span>Inicio</span>
        <span
          className={current >= total * 0.25 ? "text-blue-600 font-medium" : ""}
        >
          25%
        </span>
        <span
          className={current >= total * 0.5 ? "text-blue-600 font-medium" : ""}
        >
          50%
        </span>
        <span
          className={current >= total * 0.75 ? "text-blue-600 font-medium" : ""}
        >
          75%
        </span>
