...
const scaleLabels = [
  {
    ...
    label: "Nunca",
    color: "bg-red-500",
    description: "No me describe en absoluto",
  },
  {
    value: 2,
    label: "Rara vez",
    color: "bg-orange-500",
    description: "Me describe muy poco",
  },
  {
    value: 3,
    label: "A veces",
    color: "bg-yellow-500",
    description: "Me describe moderadamente",
  },
  {
    value: 4,
    label: "Frecuentemente",
    color: "bg-blue-500",
    description: "Me describe bastante bien",
  },
  {
    value: 5,
    label: "Siempre",
    color: "bg-green-500",
    description: "Me describe perfectamente",
  },
];
