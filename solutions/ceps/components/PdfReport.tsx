  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const pdfBlob = await buildUserPdf({
        user,
        logoUrl:
          "https://drive.google.com/uc?id=1ytsRTacOp-9ZqtIq2nxf64CYVAsBFYKD",
        scores,
        mode,
        orgInfo,
      });
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-center">
                    <Badge
                      className={`text-sm ${
                        scores.overallLevel === "Alto"
                          ? "bg-green-500"
                          : scores.overallLevel === "Promedio"
                            ? "bg-yellow-500"
                            : "bg-red-500"
                      } text-white`}
                    >
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-purple-600">
                      {
                        Object.values(scores.levelByComp).filter(
                          (l) => l === "Alto",
                        ).length
                      }
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-blue-600 text-sm">
                          Guardando en carpeta corporativa y actualizando
                          registro Excel
                        </p>
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        {uploadResult.success ? (
                          <p className="text-green-600 text-sm">
                            El reporte ha sido guardado en Google Drive y
                            registrado en Excel
                          </p>
                        ) : (
            ...
            {mode === "corporate" && (
              <div className="mt-4 p-3 bg-purple-50 rounded-lg">
                <p className="text-xs text-purple-700">
                  <strong>Modo Corporativo:</strong> El reporte se descargará en
                  tu dispositivo y también se enviará automáticamente a Google
                  Drive para registro corporativo.
                </p>
              </div>
            )}
          </Card>
