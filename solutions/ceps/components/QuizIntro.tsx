...
import { PlayCircle, Users, Building, Clock, Target, ArrowRight } from 'lucide-react';
...
export const QuizIntro: React.FC = () => {
    ...
    const handleStartQuiz = async () => {
        ...
        try {
            ...
            if (mode === 'corporate') {
                if (!corporateData.companyName || !corporateData.userName || !corporateData.userEmail) {
            ...
            <div className="max-w-4xl mx-auto">
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-yellow-700">
                                        Tienes una evaluación iniciada. ¿Deseas continuar donde la dejaste?
                                    </p>
                                </div>
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <Card
                            className={`p-6 cursor-pointer transition-all ${mode === 'user'
                        ...
                        <Card
                            className={`p-6 cursor-pointer transition-all ${mode === 'corporate'
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => setCorporateData(prev => ({
                                            ...prev,
                ...
                >
                    <Card className="p-6">
                        ...
                        <div className="space-y-3 text-gray-700">
                            <p>
                                • Responde <strong>55 preguntas</strong> sobre tus características emprendedoras
                            </p>
                            <p>
                                • Usa la escala de <strong>1 (Nunca)</strong> a <strong>5 (Siempre)</strong>
                            </p>
                            <p>
                                • No hay respuestas correctas o incorrectas, responde con honestidad
                            </p>
                            <p>
                                • Tu progreso se guarda automáticamente
                            </p>
                            <p>
                                • Al finalizar obtendrás un reporte detallado con recomendaciones
                            </p>
                        </div>
                    </Card>
                </motion.div>
