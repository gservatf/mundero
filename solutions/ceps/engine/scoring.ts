...
export function calcCorreccion(answers: AnswerMap): number {
    ...
    const base = correctionItems.reduce((acc, itemId) => acc + (answers[itemId] || 0), 0);
...
export function computeCepsScores(answers: AnswerMap): CepsScoreResult {
    ...
    const rawScores = [
        ...
        6 + getAnswer(1) + getAnswer(12) + getAnswer(23) + getAnswer(34) + getAnswer(45),

        // Persistencia  
        6 + getAnswer(2) + getAnswer(13) + getAnswer(24) + getAnswer(35) + getAnswer(46),

        // Cumplimiento
        6 + getAnswer(3) + getAnswer(14) + getAnswer(25) + getAnswer(36) + getAnswer(47),

        // Orientación a la Calidad
        6 + getAnswer(4) + getAnswer(15) + getAnswer(26) + getAnswer(37) + getAnswer(48),

        // Análisis de Riesgos (items negativos: 5, 27)
        6 - getAnswer(5) + getAnswer(16) + getAnswer(27) + getAnswer(38) + getAnswer(49),

        // Fijación de Metas (item negativo: 6)
        6 - getAnswer(6) + getAnswer(17) + getAnswer(28) + getAnswer(39) + getAnswer(50),

        // Búsqueda de Información (items negativos: 18, 30)
        6 + getAnswer(7) - getAnswer(18) + getAnswer(29) + getAnswer(40) + getAnswer(51),

        // Planificación (item negativo: 30)
        6 + getAnswer(8) + getAnswer(19) - getAnswer(30) + getAnswer(41) + getAnswer(52),

        // Redes de Apoyo (item negativo: 9)
        6 - getAnswer(9) + getAnswer(20) + getAnswer(31) + getAnswer(42) + getAnswer(53),

        // Autoconfianza (item negativo: 10)
        6 - getAnswer(10) + getAnswer(21) + getAnswer(32) + getAnswer(43) + getAnswer(54)
    ];
...
export function getCompetencyRecommendation(competencyKey: string, level: string): string {
    const recommendations: Record<string, Record<string, string>> = {
        buscar_iniciativas: {
            "Bajo": "Practica identificar oportunidades de mejora en tu entorno laboral. Comienza con pequeñas iniciativas.",
            "Promedio": "Busca proyectos donde puedas liderar nuevas ideas y soluciones innovadoras.",
        ...
        persistencia: {
            ...
            "Promedio": "Desarrolla estrategias para superar obstáculos y mantener el enfoque en objetivos de largo plazo.",
        ...
        cumplimiento: {
            ...
            "Promedio": "Busca formas de asumir mayor responsabilidad en proyectos importantes.",
        ...
        calidad: {
            ...
            "Promedio": "Identifica procesos donde puedas implementar mejoras de calidad.",
        ...
        riesgos: {
            ...
            "Promedio": "Desarrolla marcos de análisis para evaluar riesgos de manera más sistemática.",
        ...
        fijar_metas: {
            ...
            "Promedio": "Conecta tus metas personales con objetivos organizacionales más amplios.",
        ...
        informacion: {
            ...
            "Promedio": "Amplía tus fuentes de información y mejora tu análisis de datos.",
        ...
        autoconfianza: {
            ...
            "Promedio": "Busca desafíos que te permitan probar y expandir tus habilidades.",
            "Alto": "Usa tu autoconfianza para tomar decisiones difíciles y liderar en situaciones complejas."
        }
    };

    return recommendations[competencyKey]?.[level] || "Continúa desarrollando esta competencia.";
}
...
export function getOverallProfile(scores: Record<string, number>): string {
    ...
    if (strengths.includes("buscar_iniciativas") && strengths.includes("persistencia")) {
        return "leader";
    } else if (strengths.includes("calidad") && strengths.includes("cumplimiento")) {
