  ...
  const addStep = (type: FunnelStep["type"]) => {
    const stepTemplates = {
      landing: {
        ...
        content:
          "<h1>Bienvenido</h1><p>Descubre nuestra propuesta de valor única.</p>",
        order: 0,
        settings: {},
      },
      form: {
        ...
        content:
          "<h2>¡Nos interesa conocerte!</h2><p>Déjanos tus datos y te contactaremos.</p>",
        order: 0,
        settings: {
          fields: ["name", "email"],
        },
      ...
      content: {
        ...
        content:
          "<h2>Más información</h2><p>Aquí puedes agregar contenido relevante.</p>",
        order: 0,
        settings: {},
      },
      redirect: {
        ...
        title: "Redirección",
        content:
          "<h2>Redirigiendo...</h2><p>Serás redirigido automáticamente.</p>",
        order: 0,
        settings: {
                ...
                <div className="space-y-2">
                  {currentFunnel?.steps?.map((step, index) => (
                    ...
                    <p className="text-sm text-gray-500 text-center py-4">
                      No hay pasos aún. Agrega algunos usando los botones de
                      arriba.
                    </p>
                  )}
                </div>
                      ...
                      onChange={(e) =>
                        setCurrentFunnel({
                          ...
                          settings: {
                            ...
                            customFields:
                              currentFunnel?.settings?.customFields || [],
                            thankYouMessage:
                              currentFunnel?.settings?.thankYouMessage ||
                              "Thank you!",
                  ...
                  onChange={(e) =>
                    setCurrentFunnel({
                      ...
                      settings: {
                        collectEmail: true,
                        collectPhone:
                          currentFunnel?.settings?.collectPhone || false,
                        customFields:
                          currentFunnel?.settings?.customFields || [],
          ...
          {selectedStep ? (
            ...
            <div className="flex items-center justify-center h-full text-gray-500">
              <div className="text-center">
                ...
                <p className="text-sm">
                  O agrega un nuevo paso desde la barra lateral
                </p>
              </div>
            </div>
          )}
