...
export const MessageCard: React.FC<MessageCardProps> = ({
    ...
    return (
        ...
        >
            {/* Mensaje base */}
            <div
                className={`max-w-[75%] rounded-lg px-3 py-2 text-sm relative ${isOwn
            ...
            >
                ...
                {/* Timestamp */}
                <div className={`text-xs mt-1 relative z-10 ${isOwn ? 'text-blue-100' : 'text-gray-500'
                    }`}>
                    {timestamp}
                </div>
                ...
                <div className="absolute left-full ml-2 top-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50">
                    ...
                    >
                        ...
                        <div className="flex items-center space-x-2 mb-2">
                            ...
                            />
                            <div>
                                <p className="font-medium text-gray-900 text-sm">{senderName}</p>
                        ...
                        <div className="grid grid-cols-2 gap-2 text-xs">
                            ...
                            <div className="text-center">
                                <p className="font-medium text-gray-900">{userReputation?.badges?.length || 0}</p>
