    ...
    <footer className="bg-gray-50 border-t border-gray-200 py-10 px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="text-center md:text-left">
          <p className="text-gray-700 font-medium">Grupo Servat – Ecosistema Empresarial Integrado</p>
          <p className="text-gray-600 text-sm mt-1">
            Av. San Luis 2792, San Borja, Lima – Perú
          </p>
          <p className="text-gray-600 text-sm mt-1">
            <a href="mailto:contacto@mundero.net" className="hover:text-blue-600">
        ...
        <div className="text-center md:text-right">
          ...
          <p className="text-gray-500 text-xs mt-1">
            © {new Date().getFullYear()} Grupo Servat. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
