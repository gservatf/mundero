...
describe("AdminUsers Service Integration", () => {
  ...
  describe("User Service Operations", () => {
    it("should fetch users with pagination", async () => {
      (adminUserService.getUsers as any).mockResolvedValue(
    ...
    it("should handle service errors gracefully", async () => {
      ...
      (adminUserService.getUsers as any).mockRejectedValue(
        new Error(errorMessage),
      );

      await expect(adminUserService.getUsers(25, undefined)).rejects.toThrow(
        errorMessage,
      );
    });
  });
