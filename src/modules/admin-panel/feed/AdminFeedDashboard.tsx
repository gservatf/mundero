...
export const AdminFeedDashboard: React.FC = () => {
    ...
    const getMetrics = useCallback((): DashboardMetric[] => {
        ...
        const visibilityRate = stats.totalPosts > 0
    ...
    const getEngagementSummary = useCallback(() => {
        ...
        const avgSharesPerPost = totalPosts > 0 ? (totalShares / totalPosts).toFixed(1) : '0';
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-2xl font-bold text-gray-900">Dashboard del Feed</h2>
                    <p className="text-gray-600">Métricas y estadísticas del feed social</p>
                </div>
                                    ...
                                    <Card className="p-6 hover:shadow-lg transition-shadow">
                                        ...
                                        {metric.change && (
                                            <div className="flex items-center">
                                                ...
                                                <span className={`text-sm font-medium ${metric.change.type === 'increase' ? 'text-green-600' :
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex items-center space-x-4">
                                                <div className={`h-10 w-10 rounded-full flex items-center justify-center ${isToday ? 'bg-blue-100' : 'bg-gray-200'
                                                    }`}>
                                            ...
                                            <div className="flex items-center space-x-6 text-sm">
                                                <div className="text-center">
                                                    <p className="font-semibold text-gray-900">{day.posts}</p>
                                                    <p className="text-gray-500">Posts</p>
                                                </div>
                                                <div className="text-center">
                                                    <p className="font-semibold text-gray-900">{totalEngagement}</p>
                                                    <p className="text-gray-500">Engagement</p>
                                                </div>
                                                <div className="text-center">
                                                    <p className="font-semibold text-gray-900">
                                                        {day.posts > 0 ? (totalEngagement / day.posts).toFixed(1) : '0'}
                                                    </p>
                        ...
                        <Card className="p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <Button
                                    ...
                                    onClick={() => window.location.href = '/admin-panel/feed/moderation'}
                                >
                                    <Eye className="h-5 w-5 mr-2" />
                                    <div className="text-left">
                                        <p className="font-medium">Ver Moderación</p>
                                        <p className="text-xs text-gray-500">Revisar publicaciones</p>
                                    </div>
                                </Button>
                                ...
                                <Button
                                    variant="outline"
                                    className="flex items-center justify-center p-4 h-auto"
                                    onClick={() => window.location.href = '/admin-panel/feed/reports'}
                                >
                                    <AlertTriangle className="h-5 w-5 mr-2" />
                                    <div className="text-left">
                                        <p className="font-medium">Ver Reportes</p>
                                        <p className="text-xs text-gray-500">{stats?.pendingReports} pendientes</p>
                                    </div>
                                </Button>
                                ...
                                >
                                    ...
                                    <div className="text-left">
                                        ...
                                        <p className="text-xs text-gray-500">Sincronizar métricas</p>
                                    </div>
                                </Button>
                            </div>
                        </Card>
