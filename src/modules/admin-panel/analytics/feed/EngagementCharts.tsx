    ...
    const engagementDistribution = [
        {
            ...
            percentage: totalEngagement > 0 ? Math.round((analytics.totalLikes / totalEngagement) * 100) : 0,
            color: colors.danger
        },
        {
            name: 'Comentarios',
            value: analytics.totalComments,
            percentage: totalEngagement > 0 ? Math.round((analytics.totalComments / totalEngagement) * 100) : 0,
            color: colors.primary
        },
        {
            name: 'Compartidos',
            value: analytics.totalShares,
            percentage: totalEngagement > 0 ? Math.round((analytics.totalShares / totalEngagement) * 100) : 0,
                ...
                <div style={{ width: '100%', height: 250 }}>
                    <ResponsiveContainer>
                        <BarChart data={topUsersData} layout="horizontal">
                            ...
                            <Bar dataKey="comments" fill={colors.primary} name="Comentarios" />
                        </BarChart>
                    </ResponsiveContainer>
                </div>
            </Card>
