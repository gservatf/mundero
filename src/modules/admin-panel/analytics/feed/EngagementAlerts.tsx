...
const AlertDisplay: React.FC<AlertDisplayProps> = ({ alert, onDismiss, onView }) => {
    ...
    return (
        <motion.div
            ...
            className={`p-4 rounded-lg border-l-4 transition-all duration-200 cursor-pointer hover:shadow-md ${alert.priority === 'critical' ? 'border-l-red-500 bg-red-50' :
            ...
            <CardContent>
                {loading ? (
                    ...
                    <div className="text-center py-12 text-gray-500">
                        ...
                        <p className="text-sm">Las alertas aparecerán aquí cuando se detecten patrones relevantes</p>
                    </div>
                ) : (
