  ...
  titles: [
    {
      ...
      title: "Novato",
      icon: "🌱",
      description: "Comenzando tu viaje en Mundero",
    ...
    },
    {
      ...
      title: "Explorador",
      icon: "🔍",
      description: "Descubriendo nuevas oportunidades",
    ...
    },
    {
      ...
      title: "Colaborador",
      icon: "🤝",
      description: "Construyendo conexiones valiosas",
    ...
    },
    {
      ...
      title: "Contribuidor",
      icon: "💡",
      description: "Aportando valor a la comunidad",
    ...
    },
    {
      ...
      title: "Especialista",
      icon: "⭐",
      description: "Reconocido por tu expertise",
    ...
    },
    {
      ...
      title: "Mentor",
      icon: "🎓",
      description: "Guiando a otros en su crecimiento",
    ...
    },
    {
      ...
      title: "Líder",
      icon: "👑",
      description: "Inspirando y liderando iniciativas",
    ...
    },
    {
      ...
      title: "Innovador",
      icon: "🚀",
      description: "Impulsando el cambio y la innovación",
    ...
    },
    {
      ...
      title: "Visionario",
      icon: "🔮",
      description: "Viendo más allá del horizonte",
    ...
    },
    {
      ...
      title: "Maestro",
      icon: "🏆",
      description: "Maestría absoluta en tu campo",
    ...
    },
    {
      ...
      title: "Leyenda",
      icon: "💎",
      description: "Tu legado trasciende Mundero",
...
class LevelSystem {
  ...
  getLevelProgress(currentPoints: number): {
    ...
    const progressPercentage =
      totalPointsNeeded > 0
        ? Math.min((progressPoints / totalPointsNeeded) * 100, 100)
        : 100;
   ...
   */
  isSpecialMilestone(points: number): {
    isMilestone: boolean;
    milestone?: number;
    achievement?: string;
  } {
    ...
    const special = specialMilestones.find(
      (s) => Math.abs(points - s.points) <= 5,
    );
    if (special) {
      return {
        isMilestone: true,
