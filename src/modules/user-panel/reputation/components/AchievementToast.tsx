...
import { FiStar, FiAward, FiZap, FiShield, FiHeart, FiX, FiTrendingUp } from 'react-icons/fi';
...
export const AchievementToast: React.FC<AchievementToastProps> = ({
    ...
    const IconComponent = achievement.icon || ACHIEVEMENT_ICONS[achievement.type] || FiStar;
                                ...
                                <div className="flex items-center justify-between relative z-10">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm opacity-90">{getMotivationalText()}</p>
                                        </div>
                                    </div>
...
export const useAchievementToasts = () => {
    ...
    const showAchievement = (achievement: Achievement) => {
        setToasts(prev => [...prev, { ...achievement, id: Date.now().toString() }]);
    };
...
export const createLevelUpAchievement = (newLevel: number, points: number): Achievement => ({
    ...
    rarity: newLevel >= 8 ? 'legendary' : newLevel >= 5 ? 'epic' : newLevel >= 3 ? 'rare' : 'common',
    points,
    level: newLevel,
    timestamp: Date.now()
});
...
export const createMilestoneAchievement = (milestone: string, description: string): Achievement => ({
