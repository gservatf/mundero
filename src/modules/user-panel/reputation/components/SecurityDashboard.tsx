...
import { reputationSecurityManager, useSecurityStatus } from '../security/ReputationSecurity';
...
export const SecurityDashboard: React.FC = () => {
        ...
        const mockAlerts: SecurityAlert[] = [
            {
                ...
                action: 'post_like',
                riskLevel: 'high',
                issues: ['Demasiadas acciones del tipo "post_like" en la última hora (15)', 'Velocidad de acciones sospechosamente alta'],
    ...
    const getStatusIcon = (status: string) => {
        switch (status) {
            case 'resolved': return <FiCheck className="w-4 h-4 text-green-600" />;
            case 'reviewed': return <FiEye className="w-4 h-4 text-blue-600" />;
            default: return <FiClock className="w-4 h-4 text-orange-600" />;
        }
    };
    ...
    return (
        <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
            ...
            <motion.div
                ...
                className={`p-4 rounded-lg border-l-4 ${securityStatus.isRunning
            ...
            >
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                        <div className={`w-3 h-3 rounded-full ${securityStatus.isRunning ? 'bg-green-400' : 'bg-red-400'
                            }`} />
                        <span className="font-medium">
                            Estado del Sistema: {securityStatus.isRunning ? 'Activo' : 'Inactivo'}
                        </span>
                    </div>
                    <div className="text-sm text-gray-600">
                        Cola: {securityStatus.queueSize} | Usuarios en caché: {securityStatus.cachedUsers}
                    </div>
                </div>
            </motion.div>
                ...
                >
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-gray-900">{metrics.totalValidations.toLocaleString()}</p>
                        </div>
                ...
                >
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-red-600">{metrics.blockedActions}</p>
                        </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border">
                <div className="p-6 border-b border-gray-200">
                    <div className="flex items-center justify-between">
                        <h2 className="text-lg font-semibold text-gray-900">Alertas de Seguridad</h2>
                        <div className="flex items-center space-x-2">
                ...
                <div className="divide-y divide-gray-200">
                                ...
                                <div className="flex items-start justify-between">
                                    <div className="flex items-start space-x-4">
                                        <div className="flex-shrink-0">
                                            <FiAlertTriangle className={`w-5 h-5 ${alert.riskLevel === 'critical' ? 'text-red-600' :
                                        ...
                                        <div className="flex-grow">
                                            <div className="flex items-center space-x-3 mb-2">
                                                ...
                                                <span className={`px-2 py-1 text-xs rounded-full border ${getRiskColor(alert.riskLevel)}`}>
                    ...
                    {alerts.length === 0 && (
                        <div className="p-12 text-center">
                            ...
                            <p className="text-gray-600">No hay alertas de seguridad pendientes</p>
                        </div>
                    )}
                </div>
            </div>
