...
export const LevelUpModal: React.FC<LevelUpModalProps> = ({
    ...
    const [currentStep, setCurrentStep] = useState<'celebration' | 'details' | 'sharing'>('celebration');
    const [audioEnabled, setAudioEnabled] = useState(true);

    const newLevelInfo = levelUpEvent ? levelSystem.getLevelInfo(levelUpEvent.newLevel) : null;
    const oldLevelInfo = levelUpEvent ? levelSystem.getLevelInfo(levelUpEvent.oldLevel) : null;
                        ...
                        <div className="absolute inset-0 pointer-events-none overflow-hidden">
                            {[...Array(50)].map((_, i) => (
                                <motion.div
                                    ...
                                    className={`absolute w-3 h-3 ${['bg-yellow-400', 'bg-blue-400', 'bg-green-400', 'bg-purple-400', 'bg-pink-400', 'bg-red-400'][
                            ...
                            >
                                ...
                                <motion.div
                                    ...
                                    transition={{
                                        ...
                                        rotateZ: { delay: 1, duration: 2, repeat: Infinity, repeatDelay: 3 }
                                    }}
                                ...
                                >
                                    <div className="text-xl">
                                        Nivel {levelUpEvent.oldLevel} → <span className="font-bold text-yellow-300">Nivel {levelUpEvent.newLevel}</span>
                                    </div>
                                ...
                                >
                                    <div className="bg-white/20 backdrop-blur rounded-full px-6 py-3 flex items-center space-x-2">
                                        ...
                                        <span className="font-medium">+{levelUpEvent.pointsEarned} puntos</span>
                                    </div>
                                    <div className="bg-white/20 backdrop-blur rounded-full px-6 py-3 flex items-center space-x-2">
                                        <FiStar className="w-5 h-5" />
                                        <span className="font-medium">{levelUpEvent.totalPoints} total</span>
                                    </div>
                                </motion.div>
                                ...
                                <motion.div
                                    ...
                                    className="mt-8"
                                >
                                    <div className="text-sm mb-2">Progreso al siguiente nivel</div>
                                ...
                                <div className="bg-white rounded-xl p-6 space-y-6">
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="text-center">
                                                <div className="text-3xl mb-1">{oldLevelInfo?.icon}</div>
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        ...
                                        <div className="bg-white border rounded-lg p-4 text-left">
                                            <div className="flex items-center space-x-3 mb-3">
                                                ...
                                                <div>
                                                    <div className="font-medium">¡Level Up en Mundero!</div>
                                            ...
                                            <div className="text-sm text-gray-700">
                                                Acabo de alcanzar {levelUpEvent.totalPoints} puntos totales 💎
                                            </div>
                                        </div>
                                    </div>
