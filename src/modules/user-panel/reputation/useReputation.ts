...
export function useReputationHelpers() {
  ...
  const getNextLevelPoints = (currentLevel: number) =>
    reputationService.getNextLevelPoints(currentLevel);

  const getBadgeInfo = (badgeId: string) =>
    reputationService.getBadgeInfo(badgeId);
