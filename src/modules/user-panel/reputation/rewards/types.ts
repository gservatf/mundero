...
export const REWARD_TEMPLATES: Record<string, Omit<Reward, 'id' | 'createdAt' | 'updatedAt' | 'redemptionCount'>> = {
    premium_month: {
        title: 'Premium 1 Mes',
        ...
        isActive: true,
        isFeatured: true,
        metadata: { duration: 30, features: ['advanced_analytics', 'priority_support', 'custom_themes'] }
    },
