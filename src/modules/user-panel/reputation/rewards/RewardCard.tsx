...
export const RewardCard: React.FC<RewardCardProps> = ({
    ...
    const getTypeIcon = (type: string) => {
        switch (type) {
            case 'premium_features': return <FiZap className="w-4 h-4" />;
            case 'discount_code': return <FiShoppingCart className="w-4 h-4" />;
            case 'physical_item': return <FiPackage className="w-4 h-4" />;
            case 'badge': return <FiAward className="w-4 h-4" />;
        ...
        return (
            ...
            >
                <div className="flex items-center space-x-4">
                    {/* Icon */}
                    <div className={`w-16 h-16 bg-gradient-to-br ${getCategoryColor(reward.category)} rounded-xl flex items-center justify-center text-2xl shadow-lg`}>
                        {reward.icon}
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center space-x-2 mb-1">
                            <h3 className="text-lg font-semibold text-gray-900 truncate">{reward.title}</h3>
                            {reward.isFeatured && (
              ...
              `}
                        ...
                        >
                            {isRedeeming ? 'Canjeando...' : canRedeem ? 'Canjear' : 'No disponible'}
                        </button>
                    </div>
                </div>
            </motion.div>
    ...
    return (
        ...
        >
            {/* Header */}
            <div className={`h-32 bg-gradient-to-br ${getCategoryColor(reward.category)} relative`}>
