...
export const RewardsCenter: React.FC<RewardsCenterProps> = ({
  ...
  const [sortBy, setSortBy] = useState<"points" | "popularity" | "newest">(
    "points",
  );
  ...
  const categories: {
    ...
    { id: "all", name: "Todas", icon: "🎁", count: rewards.length },
    {
      ...
      name: "Premium",
      icon: "👑",
      count: getRewardsByCategory("premium").length,
    },
    {
      id: "discounts",
      name: "Descuentos",
      icon: "🎟️",
      count: getRewardsByCategory("discounts").length,
    },
    {
      id: "physical",
      name: "Físicas",
      icon: "📦",
      count: getRewardsByCategory("physical").length,
    },
    {
      id: "digital",
      name: "Digitales",
      icon: "💻",
      count: getRewardsByCategory("digital").length,
    },
    {
      id: "experiences",
      name: "Experiencias",
      icon: "🎯",
      count: getRewardsByCategory("experiences").length,
    },
    {
      id: "badges",
      name: "Badges",
      icon: "🏅",
      count: getRewardsByCategory("badges").length,
    },
    {
      id: "features",
      name: "Funciones",
      icon: "⚡",
      count: getRewardsByCategory("features").length,
    },
  ];
