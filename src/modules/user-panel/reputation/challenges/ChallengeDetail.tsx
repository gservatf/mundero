...
export const ChallengeDetail: React.FC<ChallengeDetailProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "participants" | "progress"
  >("overview");
  ...
  const getCollaborativeProgress = () => {
    ...
    const totalProgress = Object.values(challenge.progress).reduce(
      (sum, progress) => sum + progress.current,
      0,
    );
    ...
    return {
      ...
      percentage: Math.min(
        (totalProgress / challenge.objective.target) * 100,
        100,
      ),
    };
  };
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
            <div className="flex-grow">
              <div className="flex items-center space-x-3 mb-4">
                <span
                  className={`px-3 py-1 rounded-full text-xs font-medium border border-white/20 bg-white/10`}
                >
                ...
                <span
                  className={`px-3 py-1 rounded-full text-xs font-medium border border-white/20 bg-white/10`}
                >
                  {CATEGORY_CONFIG[challenge.category].icon}{" "}
                  {CATEGORY_CONFIG[challenge.category].name}
                </span>
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm">
                <div className="flex items-center">
                  ...
                  {challenge.participants.length} participante
                ...
                <div
                  className={`flex items-center ${timeRemaining.urgent ? "text-red-200" : ""}`}
                >
            ...
            {challenge.type === "collaborative" ? (
              <div className="space-y-3">
                <div className="flex items-center justify-between text-sm text-gray-600">
                  ...
                  <span>
                    {collaborativeProgress.current}/{challenge.objective.target}
                  </span>
                </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {challenge.objective.timeframe || "Total"}
                        </span>
                      </div>
                      <div className="flex justify-between">
