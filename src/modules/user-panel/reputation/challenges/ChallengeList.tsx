          ...
          {filteredChallenges.map((challenge, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className={`bg-white rounded-lg border shadow-sm overflow-hidden cursor-pointer transition-shadow hover:shadow-lg ${
                    ...
                    <div className="flex items-center space-x-2">
                      <span
                        className={`px-2 py-1 text-xs rounded-full border ${
                          DIFFICULTY_CONFIG[challenge.difficulty].color
                        }`}
                      >
                      ...
                      <span
                        className={`px-2 py-1 text-xs rounded-full ${
                          CATEGORY_CONFIG[challenge.category].color
                        }`}
                      >
