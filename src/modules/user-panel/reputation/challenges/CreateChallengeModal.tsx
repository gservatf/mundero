...
export const CreateChallengeModal: React.FC<CreateChallengeModalProps> = ({
    ...
    const [customTemplate, setCustomTemplate] = useState<Partial<ChallengeTemplate>>({});
    ...
    const handleCustomizationChange = (field: keyof ChallengeTemplate, value: any) => {
                ...
                >
                    ...
                    <div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
                        <div className="flex items-center space-x-4">
                            {[
                                { id: 'template', label: 'Plantilla', active: step === 'template' },
                                { id: 'customize', label: 'Personalizar', active: step === 'customize' },
                                { id: 'confirm', label: 'Confirmar', active: step === 'confirm' }
                            ].map((stepItem, index) => (
                                <div key={stepItem.id} className="flex items-center">
                                    <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium transition-colors ${stepItem.active
                                            ? 'bg-blue-600 text-white'
                                            : step === 'customize' && stepItem.id === 'template' ||
                                ...
                                >
                                            ...
                                            >
                                                <div className="flex items-start justify-between mb-3">
                                                    <div className="flex items-center space-x-2">
                                                        <span className={`px-2 py-1 text-xs rounded-full border ${DIFFICULTY_CONFIG[template.difficulty].color
                                                            }`}>
                                                            {DIFFICULTY_CONFIG[template.difficulty].icon} {template.difficulty.toUpperCase()}
                                                        </span>

                                                        <span className={`px-2 py-1 text-xs rounded-full ${CATEGORY_CONFIG[template.category].color
                                                            }`}>
                                    ...
                                    <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                                        <div className="flex items-start space-x-3">
                                            ...
                                            <div>
                                                <h4 className="font-medium text-blue-900">¿No encuentras lo que buscas?</h4>
                                                <p className="text-sm text-blue-700">
                                                    Selecciona cualquier plantilla y podrás personalizarla completamente en el siguiente paso.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    onChange={(e) => handleCustomizationChange('type', e.target.value as ChallengeType)}
                                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                                >
                                            ...
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    onChange={(e) => handleCustomizationChange('category', e.target.value)}
                                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                                >
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                            <div>
                                                ...
                                                <select
                                                    value={customTemplate.objective?.type || 'posts_create'}
                                                    onChange={(e) => handleCustomizationChange('objective', {
                                                        ...customTemplate.objective,
                                                        type: e.target.value
                                                    })}
                                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                                >
                                                    <option value="posts_create">Crear publicaciones</option>
                                                    <option value="likes_receive">Recibir likes</option>
                                                    <option value="comments_make">Hacer comentarios</option>
                                                    <option value="events_attend">Asistir a eventos</option>
                                                    <option value="connections_make">Hacer conexiones</option>
                                                </select>
                                            </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => handleCustomizationChange('points', parseInt(e.target.value))}
                                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                                />
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="flex space-x-2">
                                                    ...
                                                    <button
                                                        type="button"
                                                        onClick={() => {
                                                            const input = document.querySelector('input[placeholder="Escribe un tag..."]') as HTMLInputElement;
                                                            if (input?.value) {
                                                                addTag(input.value);
                                                                input.value = '';
                                                            }
                            ...
                            {step === 'confirm' && customTemplate && (
                                ...
                                >
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-6 space-y-4">
                                        <div>
                                            <h4 className="font-medium text-gray-900">{customTemplate.title}</h4>
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                            <div>
                                                ...
                                                <div className="font-medium capitalize">{customTemplate.type}</div>
                                            </div>
                                            <div>
                                                <span className="text-gray-500">Duración:</span>
                                                <div className="font-medium">{customTemplate.duration} días</div>
                                            </div>
                                            <div>
                                                <span className="text-gray-500">Objetivo:</span>
                                                <div className="font-medium">{customTemplate.objective?.target}</div>
                                            </div>
                                            <div>
                                                <span className="text-gray-500">Puntos:</span>
                                                <div className="font-medium">{customTemplate.points}</div>
                                            </div>
                                        </div>
