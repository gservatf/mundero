...
export interface Challenge {
    ...
    objective: {
        type: 'posts_create' | 'likes_receive' | 'comments_make' | 'events_attend' | 'connections_make';
...
export const CHALLENGE_TEMPLATES: ChallengeTemplate[] = [
    ...
    },
    {
        ...
        description: "Crea 5 publicaciones de alta calidad que reciban al menos 10 likes cada una",
        type: "individual",
        points: 250,
        objective: {
            type: "posts_create",
    ...
    },
    {
        ...
        description: "Realiza 20 comentarios constructivos en publicaciones de otros miembros",
        type: "individual",
        points: 120,
        objective: {
            type: "comments_make",
