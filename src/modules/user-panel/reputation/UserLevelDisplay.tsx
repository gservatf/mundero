        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between mb-1">
            <div>
              ...
              <div
                className={`${classes.level} text-gray-600 flex items-center space-x-1`}
              >
            ...
            <div className="text-right">
              <div
                className={`${classes.points} text-purple-600 font-medium flex items-center space-x-1`}
              >
          ...
          {showProgress && (
            <div className="space-y-1">
              ...
              <div
                className={`w-full bg-gray-200 rounded-full ${classes.progress} overflow-hidden`}
              >
                <motion.div
                  initial={{ width: 0 }}
