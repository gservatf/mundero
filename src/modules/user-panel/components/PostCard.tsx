...
export const PostCard: React.FC<PostCardProps> = ({
    ...
    const handleLike = async () => {
        ...
        try {
            ...
            const result = await feedService.togglePostLike(post.id, user.id, userData);
    ...
    const getVisibilityBadge = () => {
        switch (post.visibility) {
            case 'private':
                return <Badge variant="secondary" className="text-xs">Privado</Badge>;
            case 'followers':
                return <Badge variant="outline" className="text-xs">Seguidores</Badge>;
            case 'public':
            default:
                return <Badge variant="default" className="text-xs">Público</Badge>;
        }
    };
