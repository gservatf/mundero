  ...
  const filterOptions: { value: FeedFilter; label: string; count?: number }[] =
    [
      { value: "all", label: "Todos", count: posts.length },
      {
        value: "text",
        label: "Texto",
        count: posts.filter((p) => p.type === "text").length,
      },
      {
        value: "media",
        label: "Media",
        count: posts.filter((p) => p.type === "media").length,
      },
      {
        value: "shared",
        label: "Compartidos",
        count: posts.filter((p) => p.type === "shared").length,
      },
      {
        value: "event",
        label: "Eventos",
        count: posts.filter((p) => p.type === "event").length,
      },
    ];
