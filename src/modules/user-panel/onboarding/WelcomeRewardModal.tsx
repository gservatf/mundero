...
export const WelcomeRewardModal: React.FC<WelcomeRewardModalProps> = ({
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setCCurrentBadgeIndex(
        (prev) => (prev + 1) % (progress.badgesEarned?.length || 1),
      );
    }, 2000);
  ...
  const handleShareToWhatsApp = () => {
    const message =
      `¡Acabo de completar mi aventura inicial en Mundero! 🎉\n\n` +
          ...
          <div className="p-6 space-y-6">
                  ...
                  <AnimatePresence mode="wait">
                    ...
                    >
                      <div className="text-4xl mb-1">
                        {getBadgeEmoji(
                          progress.badgesEarned[currentBadgeIndex],
                        )}
                      </div>
            ...
            >
              ...
              <p className="text-xs text-gray-600 mt-1">
                Explora comunidades, conecta con otros usuarios y comparte tu
                contenido
              </p>
            </motion.div>
