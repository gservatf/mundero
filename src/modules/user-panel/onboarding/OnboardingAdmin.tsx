...
import { useOnboardingProgress, useQuestTemplates, useOnboardingStats } from './useOnboardingProgress';
...
export const OnboardingAdmin: React.FC<OnboardingAdminProps> = ({
    ...
    const handleDeleteQuest = async (questId: string) => {
        if (confirm('¿Estás seguro de que quieres eliminar esta plantilla de quest?')) {
    ...
    const getStepTypeColor = (type: OnboardingStep['type']) => {
        switch (type) {
            case 'profile_completion': return 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300';
            case 'tutorial_view': return 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300';
            case 'community_join': return 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300';
            case 'first_post': return 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-300';
            case 'first_connection': return 'bg-pink-100 text-pink-800 dark:bg-pink-900/30 dark:text-pink-300';
            case 'explore_features': return 'bg-cyan-100 text-cyan-800 dark:bg-cyan-900/30 dark:text-cyan-300';
    ...
    const getStepTypeIcon = (type: OnboardingStep['type']) => {
        switch (type) {
            case 'profile_completion': return <Users className="h-4 w-4" />;
            case 'tutorial_view': return <FileText className="h-4 w-4" />;
            case 'community_join': return <Users className="h-4 w-4" />;
            case 'first_post': return <Edit2 className="h-4 w-4" />;
            case 'first_connection': return <Users className="h-4 w-4" />;
            case 'explore_features': return <Target className="h-4 w-4" />;
    ...
    return (
        <div className={`space-y-6 ${className}`}>
            ...
            <div className="flex items-center justify-between">
                ...
                <Button onClick={handleCreateQuest} className="bg-gradient-to-r from-purple-600 to-blue-600">
                ...
                <TabsContent value="templates" className="space-y-6">
                                    ...
                                    <div className="p-4">
                                        ...
                                        <div className="text-xs text-gray-500 mb-4 space-y-1">
                                            ...
                                            <div className="flex items-center space-x-2">
                                                ...
                                                <span>Total: {template.steps.reduce((acc, step) => acc + step.points, 0)} puntos</span>
                                            </div>
                                        </div>
                    ...
                    {templatesLoading && (
                        <div className="text-center py-8">
                            ...
                            <p className="mt-2 text-gray-600 dark:text-gray-400">Cargando plantillas...</p>
                        </div>
                    )}
                </TabsContent>
