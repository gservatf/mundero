  ...
  const featuredPosts: FeaturedPost[] = [
    {
      ...
      content:
        "Nos emociona tenerte aquí. Mundero es más que una plataforma: es un ecosistema donde profesionales como tú conectan, colaboran y crecen juntos. Aquí encontrarás oportunidades únicas, una red de empresas confiables y herramientas que potenciarán tu carrera profesional.",
      author: {
        name: "Equipo Mundero",
    ...
    },
    {
      ...
      content:
        "Tu perfil es tu carta de presentación digital. Te mostramos paso a paso cómo optimizarlo para atraer las mejores oportunidades. Incluye consejos sobre cómo redactar una descripción impactante y qué información es clave para destacar.",
      author: {
        name: "María González",
    ...
    },
    {
      ...
      content:
        "Las comunidades son el corazón de Mundero. Descubre cómo identificar y unirte a grupos que realmente aporten valor a tu desarrollo profesional. Desde comunidades por industria hasta grupos de networking local.",
      author: {
        name: "Carlos Ruiz",
    ...
    },
    {
      ...
      content:
        "Una comunidad vibrante de más de 500 profesionales de tecnología que se reúnen semanalmente para compartir conocimientos, oportunidades y crear sinergias. ¡Perfecta para desarrolladores, diseñadores y product managers!",
      author: {
        name: "Ana Torres",
    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="space-y-4">
        {featuredPosts.map((post, index) => (
          ...
          >
            <Card
              className={`overflow-hidden ${post.featured ? "ring-2 ring-purple-200 dark:ring-purple-800" : ""}`}
            >
              {/* Header del post */}
      ...
      <Card className="p-6 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 border-purple-200 dark:border-purple-800">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-4">
            Comparte tu experiencia, conecta con otros profesionales y construye
            tu red.
          </p>
