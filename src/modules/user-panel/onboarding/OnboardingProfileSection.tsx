...
export const OnboardingProfileSection: React.FC<
  OnboardingProfileSectionProps
> = ({ className = "", onStartOnboarding }) => {
        ...
        <Card className="p-6 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 border-purple-200 dark:border-purple-800">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Completa tu onboarding para desbloquear todas las funcionalidades
              y obtener recompensas exclusivas.
            </p>
            <Button
  ...
  const completedSteps =
    progress.steps?.filter((step) => step.isCompleted || step.done).length || 0;
  ...
  const daysActive = startedAt
    ? Math.ceil(
        (new Date().getTime() - startedAt.getTime()) / (1000 * 60 * 60 * 24),
      )
    : 0;
  const completionPercentage =
    progress.completionPercentage || progress.progress || 0;
  const totalPointsEarned =
    progress.totalPointsEarned || progress.totalPoints || 0;
  return (
    <div className={`space-y-4 ${className}`}>
        ...
        <div className="p-6 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20">
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              <div
                className={`w-20 h-20 bg-gradient-to-br ${getMedalColor()} rounded-full flex items-center justify-center shadow-lg`}
              >
                {getMedalIcon()}
              </div>
      ...
      {completionPercentage < 100 && (
        <Card className="p-6">
          ...
          {progress.steps &&
            (progress.currentStepIndex || 0) < progress.steps.length && (
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                      {
                        progress.steps[progress.currentStepIndex || 0]
                          ?.description
                      }
                    </p>
                    <div className="flex items-center justify-between">
                      <Badge variant="outline" className="text-xs">
                        {progress.steps[progress.currentStepIndex || 0]?.points}{" "}
                        puntos
                      </Badge>
                      <Button
                        size="sm"
      ...
      {completionPercentage === 100 && (
        <Card className="p-6 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-green-200 dark:border-green-800">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Has completado exitosamente tu onboarding. Ahora dominas todas las
              herramientas para hacer networking profesional efectivo.
            </p>
