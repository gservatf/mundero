...
export const OnboardingFeedBanner: React.FC<OnboardingFeedBannerProps> = ({
    ...
    const { progress, needsOnboarding, currentStep, completionPercentage } = useOnboardingProgress();
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-gray-300">
                                            Tu progreso: {Math.round(completionPercentage)}% completado
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="mb-4">
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <span className="text-sm text-gray-600 dark:text-gray-400">
                                        {progress.steps.filter(s => s.done).length} / {progress.steps.length} pasos
                                    </span>
                                </div>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-4 text-sm text-gray-600 dark:text-gray-400">
                                    <div className="flex items-center space-x-1">
                                        ...
                                        <span>{progress.steps.filter(s => s.done).length} completadas</span>
                                    </div>
                                    <div className="flex items-center space-x-1">
                                        <Target className="h-4 w-4 text-blue-500" />
                                        <span>{progress.steps.length - progress.steps.filter(s => s.done).length} pendientes</span>
                                    </div>
                                </div>
                ...
                <div className="space-y-2 mb-4">
                    {pendingTasks.slice(0, 2).map((task) => (
                        <div key={task.id} className="flex items-center space-x-2 text-sm">
                            ...
                            <span className="text-xs text-orange-600 dark:text-orange-400">+{task.points}pts</span>
                        </div>
                    ))}
