...
export const OnboardingQuest: React.FC<OnboardingQuestProps> = ({
                        ...
                        <div className="text-center">
                            ...
                            <div className="flex items-center justify-center space-x-4 text-sm text-gray-600 mb-4">
                                ...
                                <div className="flex items-center space-x-1">
                                    ...
                                    <span>{progress?.badgesEarned?.length || 0} badges obtenidos</span>
                                </div>
                            </div>
    ...
    if (isMinimized) {
        return (
            ...
            >
                <Card className="p-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white shadow-lg cursor-pointer"
                    onClick={onMinimize}>
                        ...
                        <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white p-6">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <h2 className="text-xl font-bold">Tu Aventura en Mundero</h2>
                    ...
                    <div className="p-6 space-y-4">
                        <AnimatePresence>
                            {progress?.steps.map((step, index) => {
                                ...
                                const isLocked = !isCompleted && step.id !== progress.currentStepId;
