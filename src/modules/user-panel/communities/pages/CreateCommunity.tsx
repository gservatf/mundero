...
export const CreateCommunity: React.FC = () => {
  ...
  const addRule = () => {
    if (
      currentRule.trim() &&
      !formData.rules?.includes(currentRule.trim()) &&
      (formData.rules?.length || 0) < 10
    ) {
      setFormData((prev) => ({
        ...prev,
            ...
            <div>
              ...
              <div className="flex gap-2 mt-2">
                ...
                <Button
                  ...
                  onClick={addRule}
                  disabled={
                    !currentRule.trim() || (formData.rules?.length || 0) >= 10
                  }
                >
                  Agregar
                </Button>
              ...
              <div className="space-y-4 mt-4">
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <Button
                    type="button"
                    variant={
                      formData.settings.allowInvites ? "default" : "outline"
                    }
                    size="sm"
                    onClick={() =>
                      handleSettingsChange(
                        "allowInvites",
                        !formData.settings.allowInvites,
                      )
                    }
                  >
                    {formData.settings.allowInvites
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      Las solicitudes de membresía deben ser aprobadas
                    </div>
                  </div>
                  <Button
                    type="button"
                    variant={
                      formData.settings.requireApproval ? "default" : "outline"
                    }
                    size="sm"
                    onClick={() =>
                      handleSettingsChange(
                        "requireApproval",
                        !formData.settings.requireApproval,
                      )
                    }
                  >
                    {formData.settings.requireApproval
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      Los miembros pueden crear publicaciones
                    </div>
                  </div>
                  <Button
                    type="button"
                    variant={
                      formData.settings.allowMemberPosts ? "default" : "outline"
                    }
                    size="sm"
                    onClick={() =>
                      handleSettingsChange(
                        "allowMemberPosts",
                        !formData.settings.allowMemberPosts,
                      )
                    }
                  >
                    {formData.settings.allowMemberPosts
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      Los miembros pueden crear eventos
                    </div>
                  </div>
                  <Button
                    type="button"
                    variant={
                      formData.settings.allowMemberEvents
                        ? "default"
                        : "outline"
                    }
                    size="sm"
