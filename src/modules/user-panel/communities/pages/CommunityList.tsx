...
export const CommunityList: React.FC = () => {
  ...
  const loadAdminCommunities = async () => {
    ...
    try {
      const adminComms = await communityService.getUserAdminCommunities(
        user.id,
      );
  ...
  const filteredCommunities = communities.filter((community) => {
    ...
    const matchesCategory =
      !selectedCategory || community.category === selectedCategory;
          ...
          {adminCommunities.length > 0 ? (
            <div className="space-y-4">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <p className="text-blue-700 text-sm">
                  Tienes permisos de administración en estas comunidades. Puedes
                  gestionar miembros, moderar contenido y configurar la
                  comunidad.
                </p>
              </div>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 mb-4">
                Crea tu primera comunidad o conviértete en administrador de una
                existente
              </p>
              <Button onClick={() => setShowCreateModal(true)}>
                <Plus className="w-4 h-4 mr-2" />
