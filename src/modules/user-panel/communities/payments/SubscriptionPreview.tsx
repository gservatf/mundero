    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {AVAILABLE_PLANS.map((plan) => {
          ...
          const canUpgrade =
            status.currentPlan !== plan.id && plan.id !== "free";
        ...
        <div className="text-center p-6 bg-blue-50 rounded-lg border border-blue-200">
          <div className="space-y-2">
            ...
            <p className="text-sm text-blue-700">
              Estamos trabajando en traerte planes premium con funciones
              avanzadas. Mientras tanto, disfruta de todas las funciones
              gratuitas.
            </p>
          </div>
        </div>
      ...
      {PAYMENT_ENABLED && status.currentPlan !== "free" && (
        <div className="text-center p-4 bg-gray-50 rounded-lg">
          <p className="text-sm text-gray-600">
            ...
            <a
              href="mailto:support@mundero.net"
