...
import { PAYMENT_ENABLED, getPlanById, formatPrice, canUpgradeTo } from './paymentConfig';
...
export function UpgradePlanModal({ isOpen, onClose, userId, targetPlanId }: UpgradePlanModalProps) {
