...
class MembershipService {
  ...
  private async canAssignRole(
    ...
    try {
      const assignerMember = await this.findMemberDocument(
        communityId,
        assignerId,
      );
  ...
  private async findMemberDocument(
    communityId: string,
    userId: string,
  ...
  getTierInfo(tier: MembershipTier): {
    name: string;
    color: string;
    icon: string;
  } {
  ...
  getRoleInfo(role: CommunityRole): {
    name: string;
    color: string;
    icon: string;
  } {
