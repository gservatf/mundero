  ...
  const mockUsers: UserProfile[] = [
    {
      ...
      photo_url:
        "https://ui-avatars.com/api/?name=Gabriel+Servat&background=3b82f6&color=fff",
      role: "SUPER_ADMIN",
      status: "active",
      provider: "google",
      email_verified: true,
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Solo los Super Administradores pueden acceder a la gestión de
            usuarios.
          </p>
        </div>
      </div>
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Centro de autenticación para el ecosistema Mundero
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            <h3 className="text-lg font-medium text-blue-900">
              Hub de Identidad Firebase
            </h3>
            <p className="text-blue-700 mt-1">
              Mundero actúa como centro de autenticación principal. Los usuarios
              se autentican aquí y su identidad se sincroniza automáticamente
              con las aplicaciones del ecosistema (Legalty, We Consulting,
              Portales, Pitahaya) que manejan sus propios datos en Supabase.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-500">
            Información del usuario autenticado en Firebase
          </p>
        </div>
            ...
            >
              ...
              <div className="flex-1">
                <div className="flex items-center space-x-3 mb-2">
                  ...
                  <span
                    className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full border ${getRoleColor(currentUser.role)}`}
                  >
                  ...
                  <span
                    className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full border ${getStatusColor(currentUser.status)}`}
                  >
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-500">
            Estado de las integraciones disponibles
          </p>
        </div>
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    Gestiona sus propios datos en Supabase
                  </p>
                </div>
