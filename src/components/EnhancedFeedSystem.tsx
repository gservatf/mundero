  ...
  const [posts] = useState<Post[]>([
    {
      ...
      content:
        "🚀 Increíble presentación sobre transformación digital en el sector minero. Los resultados hablan por sí solos: 40% de reducción en costos operativos y 60% de mejora en eficiencia. Aquí les comparto el video completo de nuestra conferencia.",
      media: [
        {
          type: "video",
      ...
      externalLink: {
        ...
        description:
          "Documento PDF con casos de estudio, métricas y estrategias implementadas.",
        thumbnail:
    ...
    },
    {
      ...
      content:
        "🏗️ Proyecto de construcción sostenible completado con éxito. Implementamos tecnologías verdes que no solo protegen el medio ambiente, sino que generan ahorros del 35% en costos energéticos. Miren estas imágenes del proceso y resultado final.",
      media: [
        {
          type: "image",
    ...
    },
    {
      ...
      content:
        "💡 ¿Sabían que el 78% de las PYMEs peruanas aún no han adoptado herramientas de IA? En mi último video analizo las barreras principales y comparto 5 estrategias prácticas para comenzar la transformación digital sin grandes inversiones.",
      media: [
        {
          type: "video",
      ...
      externalLink: {
        ...
        description:
          "Carpeta con plantillas, checklists y guías paso a paso para implementar IA en pequeñas empresas.",
        thumbnail:
        ...
        <div className="aspect-video bg-gray-900 rounded-lg overflow-hidden">
          {media[currentIndex].type === "video" ? (
            ...
            <img
              ...
              onClick={() =>
                setSelectedMedia({ post: postId, index: currentIndex })
              }
            />
          )}
        </div>
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <div className="flex items-center space-x-2 text-xs text-gray-500">
                {link.domain.includes("drive.google") && (
                  <FaGoogleDrive className="w-3 h-3" />
                )}
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Descubre, comparte y conecta con contenido relevante
          </p>
        </div>
        <button
          ...
          >
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2 text-sm text-gray-500">
                      ...
                      <span>•</span>
                      <span>
                        {post.author.followers.toLocaleString()} seguidores
                      </span>
                      <span>•</span>
            ...
            <div className="p-6">
              ...
              <div className="flex items-center justify-between text-sm text-gray-500 mb-4 pt-4 border-t border-gray-50">
                <div className="flex items-center space-x-4">
                  <span>
                    {post.engagement.views.toLocaleString()} visualizaciones
                  </span>
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setNewPost({ ...newPost, currentLink: e.target.value })
                      }
        ...
        {selectedMedia && (
          ...
          >
            ...
            >
              <img
                src={
                  posts.find((p) => p.id === selectedMedia.post)?.media[
                    selectedMedia.index
                  ]?.url
                }
                alt="Media preview"
