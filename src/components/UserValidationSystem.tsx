...
const UserValidationSystem = () => {
  ...
  const [validationRequests] = useState<ValidationRequest[]>([
    {
      ...
      details:
        "Carlos solicita validación de su experiencia liderando el proyecto de transformación digital en el sector construcción, donde trabajamos juntos durante 8 meses implementando soluciones tecnológicas innovadoras.",
      status: "pending",
    ...
    },
    {
      ...
      details:
        "Ana busca validación de sus habilidades en estrategia de negocios digitales basada en nuestra colaboración en el desarrollo de su startup tecnológica.",
      status: "pending",
  ...
  const [endorsements] = useState<UserEndorsement[]>([
    {
      ...
      message:
        "Excelente profesional con gran capacidad analítica y visión estratégica. Su trabajo en nuestro proyecto de optimización de procesos fue excepcional.",
      rating: 5,
    ...
    },
    {
      ...
      message:
        "Liderazgo excepcional y capacidad para entregar resultados en tiempo y forma. Altamente recomendado para proyectos complejos.",
      rating: 5,
  ...
  const tabs = [
    {
      ...
      icon: FiUser,
      count: validationRequests.filter((r) => r.status === "pending").length,
    },
    { id: "sent", label: "Solicitudes Enviadas", icon: FiUserPlus, count: 3 },
    {
      id: "endorsements",
      label: "Mis Validaciones",
      icon: FiAward,
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
      ...
      case "recommendation":
        return <FiThumbsUp className="w-4 h-4 text-purple-500" />;
      case "endorsement":
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Valida y obtén validaciones de tu experiencia profesional
          </p>
        </div>
        <button
                    ...
                    <div className="flex items-start space-x-4 flex-1">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-600 mb-1">
                          {request.requester.title} en{" "}
                          {request.requester.company}
                        </p>
                        <p className="text-sm text-gray-500 mb-3">
                          {request.requester.mutualConnections} conexiones en
                          común
                        </p>
                        ...
                        <div className="flex items-center space-x-2 mb-3">
                          ...
                          <span className="font-medium text-gray-900">
                            Solicita validación de{" "}
                            {getTypeLabel(request.type).toLowerCase()}:{" "}
                          </span>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4 text-sm text-gray-500">
                        <span className="flex items-center space-x-1">
                          <FiEye className="w-4 h-4" />
                          <span>
                            {endorsement.isPublic ? "Público" : "Privado"}
                          </span>
                        </span>
                      </div>
                      <button className="text-blue-600 hover:text-blue-700 text-sm font-medium">
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-bold text-gray-900">
                  Revisar Solicitud de Validación
                </h3>
                <button
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-xl">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 text-lg">
                      {showValidationModal.requester.name}
                    </h4>
                    <p className="text-gray-600">
                      {showValidationModal.requester.title}
                    </p>
                    <p className="text-gray-500">
                      {showValidationModal.requester.company}
                    </p>
                  </div>
                </div>
                ...
                {/* Evidence */}
                {showValidationModal.evidence &&
                  showValidationModal.evidence.length > 0 && (
                    <div>
              ...
              <div className="flex justify-end space-x-3 mt-8 pt-6 border-t">
                <button
                  onClick={() =>
                    handleValidation(showValidationModal.id, "reject")
                  }
                ...
                <button
                  onClick={() =>
                    handleValidation(showValidationModal.id, "approve")
                  }
