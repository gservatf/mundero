...
import { FiSettings, FiActivity, FiCheck, FiAlertTriangle, FiX, FiRefreshCw, FiEye } from 'react-icons/fi';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold text-gray-900">Hub de Integraciones</h3>
          <p className="text-sm text-gray-600">Monitorea y gestiona las conexiones con aplicaciones externas</p>
        </div>
        <button
          ...
          >
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className={`px-2 py-1 text-xs rounded-full ${getStatusColor(integration.status)}`}>
                  {integration.status === 'active' ? 'Activo' : 
                   integration.status === 'warning' ? 'Advertencia' : 'Error'}
                </span>
              </div>
            </div>
            ...
            <div className="space-y-3 mb-4">
              <div className="flex justify-between text-sm">
                ...
                <span className="text-gray-900 font-mono text-xs">{integration.baseUrl}</span>
              </div>
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-gray-900">{integration.webhooks.length}</span>
              </div>
            </div>

            {/* Webhooks List */}
            <div className="mb-4">
              <p className="text-sm font-medium text-gray-700 mb-2">Webhooks configurados:</p>
      ...
      {showLogs && (
        ...
        >
          <div className="p-4 border-b">
            ...
            <p className="text-sm text-gray-600">Historial de eventos y sincronizaciones</p>
          </div>
        ...
        >
          ...
          >
            ...
            <div className="space-y-6">
              {/* Integration Details */}
              <div>
                <h4 className="font-medium text-gray-900 mb-3">Detalles de la Integración</h4>
                <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      v{integrations.find(i => i.id === selectedIntegration)?.version}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Estado:</span>
                    <span className={`px-2 py-1 text-xs rounded-full ${
                      getStatusColor(integrations.find(i => i.id === selectedIntegration)?.status || '')
                    }`}>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      value={integrations.find(i => i.id === selectedIntegration)?.baseUrl || ''}
                      readOnly
                    />
                  </div>
              ...
              <div>
                <h4 className="font-medium text-gray-900 mb-3">Configuración de Webhooks</h4>
                <div className="space-y-3">
                  {integrations.find(i => i.id === selectedIntegration)?.webhooks.map((webhook, index) => (
