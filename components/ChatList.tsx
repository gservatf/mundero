              ...
              <CardContent className="p-3">
                <div className="flex items-center space-x-3">
                  <Avatar className="w-12 h-12">
                    <AvatarImage src={`https://api.dicebear.com/7.x/initials/svg?seed=${getOtherMemberName(chat.members)}`} />
                    <AvatarFallback>
                      {getOtherMemberName(chat.members).substring(0, 2).toUpperCase()}
                    </AvatarFallback>
                  </Avatar>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between">
                      <p className="text-sm text-gray-600 truncate">
                        ...
                        {truncateMessage(chat.lastMessage, chat.lastMessageType)}
                      </p>
