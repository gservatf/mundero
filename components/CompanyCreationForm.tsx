...
import { FiHome, FiCheck, FiX, FiUser, FiMail, FiPhone, FiMapPin, FiFileText } from 'react-icons/fi';
...
const CompanyCreationForm: React.FC<CompanyCreationFormProps> = ({ isOpen, onClose, onSubmit }) => {
  ...
  const handleSubmit = () => {
    if (!validateRUC(formData.ruc)) {
      toast.error('RUC inválido. Debe tener 11 dígitos y comenzar con 10, 15, 17 o 20');
      return;
    }

    if (!formData.nombre || !formData.ruc || !formData.telefono) {
      toast.error('Por favor completa los campos obligatorios: Nombre, RUC y Teléfono');
      return;
    }

    onSubmit(formData);
    toast.success('Empresa registrada exitosamente. Estado: En Proceso - Pendiente de validación por MUNDERO.');
    onClose();
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-100">Completa la información básica de tu empresa</p>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-medium text-blue-900">Registro Simplificado</h4>
                  <p className="text-blue-700 text-sm mt-1">
                    Solo necesitas completar la información básica. Los documentos se subirán posteriormente a través del panel de administración de MUNDERO.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange('empleados', parseInt(e.target.value) || 1)}
                  className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900"
                  min="1"
                />
              </div>
              ...
              <div className="md:col-span-2">
                <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-medium text-green-900">Información de Contexto</h4>
                      <p className="text-green-700 text-sm mt-1">
                        Ayúdanos a entender mejor tu situación y necesidades empresariales.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange('empresaInteres', e.target.value)}
                  className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900"
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  onChange={(e) => handleInputChange('notasContexto', e.target.value)}
                  rows={4}
                  className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900"
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm text-yellow-800">
                <div className="flex items-center space-x-2">
                  ...
                  <span><strong>Paso 1:</strong> Registro inicial (Estado: En Proceso)</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span><strong>Paso 2:</strong> El equipo MUNDERO revisará tu información y contexto</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                  <span><strong>Paso 3:</strong> Validación final (Estado: Validada o Rechazada)</span>
                </div>
              </div>
            </div>
          </div>
