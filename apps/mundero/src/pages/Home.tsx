            ...
            <div className="flex items-center space-x-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <span className="text-xs text-gray-500 font-medium">v1.1 • Grupo Servat</span>
                </div>
              </div>
            ...
            <Card className="bg-white/60 backdrop-blur-sm border border-white/20 shadow-xl">
              <CardHeader className="pb-4">
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle className="text-2xl font-bold text-gray-900">Panel de Aplicaciones</CardTitle>
                    <p className="text-gray-600 mt-1">Accede a todas tus herramientas de trabajo</p>
                  </div>
          ...
          <TabsContent value="profile" className="space-y-6 min-h-[600px]">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <Card className="bg-white/60 backdrop-blur-sm border border-white/20 shadow-xl">
                  <CardHeader>
                    <CardTitle className="text-xl font-bold">Estadísticas del Usuario</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="text-center p-4 bg-blue-50 rounded-xl">
                        <div className="text-2xl font-bold text-blue-600">4</div>
                        <div className="text-sm text-gray-600">Apps Disponibles</div>
                      </div>
                      <div className="text-center p-4 bg-green-50 rounded-xl">
                        <div className="text-2xl font-bold text-green-600">{userRoles.length}</div>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-semibold text-green-600">Ahora</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">Sesiones esta semana</span>
                        <span className="font-semibold">12</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">Apps más usada</span>
                ...
                <Card className="bg-white/60 backdrop-blur-sm border border-white/20 shadow-xl">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {[
                        { app: 'LEGALITY360°', action: 'Revisión de contratos', time: 'Hace 2 horas' },
                        { app: 'SERVAT Portal', action: 'Actualización de perfil', time: 'Ayer' },
                        { app: 'Analytics', action: 'Consulta de reportes', time: 'Hace 3 días' }
                      ].map((activity, index) => (
                        <div key={index} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-0">
                          <div>
                            <p className="font-medium text-gray-900">{activity.app}</p>
            ...
            <Card className="bg-white/60 backdrop-blur-sm border border-white/20 shadow-xl">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {[
                    { title: 'Gestión de Usuarios', desc: 'Administrar cuentas y permisos', icon: Users, color: 'blue' },
                    { title: 'Configuración de Apps', desc: 'Configurar aplicaciones disponibles', icon: Grid3X3, color: 'green' },
                    { title: 'Roles y Permisos', desc: 'Definir niveles de acceso', icon: Settings, color: 'purple' }
                  ].map((item, index) => (
                    <Card key={index} className="p-6 hover:shadow-lg transition-shadow cursor-pointer bg-gradient-to-br from-white to-gray-50">
                ...
                <div className="mt-8 text-center py-8 bg-gray-50 rounded-xl">
                  ...
                  <p className="text-gray-600 mb-4 max-w-md mx-auto">
                    Las herramientas de administración estarán disponibles en la próxima versión. 
                    Contacta al equipo técnico para configuraciones avanzadas.
                  </p>
