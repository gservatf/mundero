      ...
      if (firebaseUser) {
        ...
        const userProfile: UserProfile = {
          ...
          photo_url:
            ...
            `https://ui-avatars.com/api/?name=${encodeURIComponent(firebaseUser.displayName || "Usuario")}&background=3b82f6&color=fff`,
          role:
            firebaseUser.email === "gservat@angloamericana.edu.pe"
              ? "SUPER_ADMIN"
              : "USER",
          status: "active",
          provider: "google",
